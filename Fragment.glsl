...
layout(location = 11) uniform bool hasNormalmap;
layout(location = 12) uniform bool hasAlbedoMap;
...
layout(location = 13) uniform vec3 matAmbient;
layout(location = 14) uniform vec3 matDiffuse;
layout(location = 15) uniform vec3 matSpecular;
layout(location = 16) uniform vec3 matEmissive;
